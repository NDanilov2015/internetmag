var EcommerceProducts = function () {
    ...
    var handleProducts = function() {
        ...
        grid.getTableWrapper().on('click', '.table-group-promo-action-submit', function (e) {
		 ...
		 // handle group "Publish/Unpublish/Deleted list actions" submit button click
        grid.getTableWrapper().on('click', '.table-group-itemstatus-action-submit', function (e) {
            e.preventDefault();
            var action = $(".table-group-itemstatus-action-input", grid.getTableWrapper());
