...
<link href="{{ asset("metronic/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css") }}" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN PAGE STYLES -->
<link href="{{ asset("metronic/admin/pages/css/tasks.css") }}" rel="stylesheet" type="text/css"/>
<!-- END PAGE STYLES -->

<!-- Отправить на место это дело! -->
...
@section('content')
{{-- А выведена будет кривой дорогой из /partials/admin/content.blade.php!
	 Где оператор @yield('content'), в том шаблоне и выведется
	 Здесь нелинейные, хитрозапутанные связи!
	--}}
...
<script src="{{ asset("metronic/global/plugins/bootstrap-daterangepicker/moment.min.js") }}" type="text/javascript"></script>
...
<script src="{{ asset("metronic/admin/pages/scripts/index.js") }}" type="text/javascript"></script>
<script src="{{ asset("metronic/admin/pages/scripts/tasks.js") }}" type="text/javascript"></script>
