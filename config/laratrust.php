...
return [
    ...
    */
    'tables' => [
         ...
         */
        'role_user' => 'role_user', //Это pivot_table известная как item_category

        /**
         * Permission - User intermediate table.
         */
        'permission_user' => 'permission_user', //Это pivot_table известная как item_category

        /**
         * Permission - Role intermediate table.
         */
        'permission_role' => 'permission_role', //Это pivot_table известная как item_category
